...
<body class="bg-gray-50">
    ...
    <div class="flex min-h-screen">
        ...
        <nav class="w-80 bg-gray-800 text-white h-screen fixed left-0 overflow-y-auto z-30 border-r border-gray-700 sidebar-transition lg:translate-x-0 -translate-x-full" id="leftSidebar">
            ...
            <div class="py-4 flex flex-col h-[calc(100vh-120px)]">
                <div class="flex-1 overflow-y-auto">
                    ...
                    <div class="mb-2">
                        <button class="flex items-center justify-between w-full px-6 py-3 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_page == 'getting-started' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                        ...
                        <div class="mt-1 <?php echo $active_page == 'getting-started' ? 'block' : 'hidden'; ?>" id="getting-started-dropdown">
                            <!-- Introduction -->
                            ...
                            <div class="mt-1">
                                <button class="flex items-center justify-between w-full pl-12 pr-6 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_section == 'installation' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                ...
                                <div class="mt-1 <?php echo $active_section == 'installation' ? 'block' : 'hidden'; ?>" id="installation-dropdown">

                                    <!-- Cloud Installation Dropdown -->
                                    <div class="mt-1">
                                        <button class="flex items-center justify-between w-full pl-16 pr-6 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'cloud' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                        ...
                                        <div class="mt-1 <?php echo strpos($active_subsection, 'cloud') === 0 ? 'block' : 'hidden'; ?>" id="cloud-dropdown">
                                    ...
                                    <div class="mt-1">
                                        <button class="flex items-center justify-between w-full pl-16 pr-6 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                        ...
                                        <div class="mt-1 <?php echo strpos($active_subsection, 'self-hosted') === 0 ? 'block' : 'hidden'; ?>" id="self-hosted-dropdown">
                                            ...
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/react'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-react' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ React
                                            </a>
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/angular'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-angular' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ Angular
                                            </a>
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/vue'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-vue' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ Vue.js
                                            </a>
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/blazor'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-blazor' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ Blazor
                                            </a>
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/svelte'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-svelte' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ Svelte
                                            </a>
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/web-component'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-webcomponent' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ Web Component
                                            </a>
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/jquery'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-jquery' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ jQuery
                                            </a>
                                            <a href="<?php echo base_url('documentation/getting-started/installation/self-hosted/java-swing'); ?>"
                                                class="block pl-24 pr-6 py-1 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors <?php echo $active_subsection == 'self-hosted-java' ? 'bg-gray-700 text-blue-400' : ''; ?>"
                                                onclick="closeMobileSidebar()">
                                                ◦ Java Swing
                                            </a>
                                        </div>
        ...
        <main class="flex-1 lg:ml-80 lg:mr-80 min-h-screen mobile-full main-content-full">
            ...
            <div class="bg-white border-b border-gray-200 px-8 py-4 justify-between items-center sticky top-0 z-20 lg:flex hidden">
                <div class="text-sm text-gray-600">
                    <a href="<?php echo base_url('documentation'); ?>" class="text-blue-500 hover:text-blue-700">Documentation</a>
            ...
            <div class="lg:hidden bg-white border-b border-gray-200 px-4 py-3">
                <div class="text-sm text-gray-600 truncate">
                    <a href="<?php echo base_url('documentation'); ?>" class="text-blue-500 hover:text-blue-700">Docs</a>
                    <?php if ($active_page != 'overview'): ?>
                        <span class="mx-2">></span>
            ...
            <div class="p-4 lg:p-8 max-w-full">
                ...
                if ($active_page == 'overview') {
                    ...
                    if ($active_section == 'getting-started') {
                        ...
                        } elseif ($active_subsection == 'self-hosted-react') {
                            $view_file .= 'getting_started_self_hosted_react';
                        } elseif ($active_subsection == 'self-hosted-angular') {
                            $view_file .= 'getting_started_self_hosted_angular';
                        } elseif ($active_subsection == 'self-hosted-vue') {
                            $view_file .= 'getting_started_self_hosted_vue';
                        } elseif ($active_subsection == 'self-hosted-blazor') {
                            $view_file .= 'getting_started_self_hosted_blazor';
                        } elseif ($active_subsection == 'self-hosted-svelte') {
                            $view_file .= 'getting_started_self_hosted_svelte';
                        } elseif ($active_subsection == 'self-hosted-webcomponent') {
                            $view_file .= 'getting_started_self_hosted_webcomponent';
                        } elseif ($active_subsection == 'self-hosted-jquery') {
                            $view_file .= 'getting_started_self_hosted_jquery';
                        } elseif ($active_subsection == 'self-hosted-java') {
                            $view_file .= 'getting_started_self_hosted_java';
        ...
        <aside class="w-80 bg-white border-l border-gray-200 h-screen fixed right-0 overflow-y-auto z-20 hidden xl:block right-sidebar">
            <div class="p-6">
                <!-- Help Card -->
    ...
    <script>
        ...
        // Auto-open dropdowns based on active states
        document.addEventListener('DOMContentLoaded', function() {
            <?php if ($active_page == 'getting-started'): ?>
                document.getElementById('getting-started-dropdown')?.classList.remove('hidden');
                document.getElementById('getting-started-arrow')?.classList.add('rotate-180');
            <?php endif; ?>

            <?php if ($active_section == 'installation'): ?>
                document.getElementById('installation-dropdown')?.classList.remove('hidden');
                document.getElementById('installation-arrow')?.classList.add('rotate-180');
            <?php endif; ?>

            <?php if (strpos($active_subsection, 'cloud') === 0): ?>
                document.getElementById('cloud-dropdown')?.classList.remove('hidden');
                document.getElementById('cloud-arrow')?.classList.add('rotate-180');
            <?php endif; ?>

            <?php if (strpos($active_subsection, 'self-hosted') === 0): ?>
                document.getElementById('self-hosted-dropdown')?.classList.remove('hidden');
                document.getElementById('self-hosted-arrow')?.classList.add('rotate-180');
            <?php endif; ?>
        });
