                    ...
                    <div class="bg-gray-900 text-gray-100 p-6 rounded-lg font-mono text-sm overflow-x-auto">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-4"></span><span class="text-purple-400">const</span> <span class="text-gray-300">editorRef = </span><span class="text-yellow-300">useRef</span><span class="text-gray-300">(</span><span class="text-blue-400">null</span><span class="text-gray-300">);</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-8"></span><span class="text-purple-400">if</span> <span class="text-gray-300">(editorRef.</span><span class="text-blue-400">current</span><span class="text-gray-300">) {</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">9</span>
                                <span class="text-gray-300 ml-12"></span><span class="text-yellow-300">console</span><span class="text-gray-300">.</span><span class="text-yellow-300">log</span><span class="text-gray-300">(editorRef.</span><span class="text-blue-400">current</span><span class="text-gray-300">.</span><span class="text-yellow-300">getContent</span><span class="text-gray-300">());</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-4"></span><span class="text-purple-400">return</span> <span class="text-gray-300">(</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-12"></span><span class="text-gray-300">&lt;</span><span class="text-yellow-300">Editor</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">16</span>
                                <span class="text-gray-300 ml-16"></span><span class="text-blue-400">apiKey</span><span class="text-gray-300">=</span><span class="text-green-400">'no-api-key'</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">17</span>
                                <span class="text-gray-300 ml-16"></span><span class="text-blue-400">onInit</span><span class="text-gray-300">=</span><span class="text-purple-400">{</span> <span class="text-gray-300">(</span><span class="text-blue-400">_evt</span><span class="text-gray-300">, </span><span class="text-blue-400">editor</span><span class="text-gray-300">) =&gt; editorRef.</span><span class="text-blue-400">current</span> <span class="text-gray-300">= editor }</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">18</span>
                                <span class="text-gray-300 ml-16"></span><span class="text-blue-400">initialValue</span><span class="text-gray-300">=</span><span class="text-green-400">"&lt;p&gt;This is the initial content of the editor.&lt;/p&gt;"</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">19</span>
                                <span class="text-gray-300 ml-16"></span><span class="text-blue-400">init</span><span class="text-gray-300">=</span><span class="text-purple-400">{{</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">20</span>
                                    <span class="text-gray-300 ml-20"></span><span class="text-blue-400">height</span><span class="text-gray-300">: </span><span class="text-orange-400">500</span><span class="text-gray-300">,</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">21</span>
                                    <span class="text-gray-300 ml-20"></span><span class="text-blue-400">menubar</span><span class="text-gray-300">: </span><span class="text-blue-400">false</span><span class="text-gray-300">,</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">22</span>
                                    <span class="text-gray-300 ml-20"></span><span class="text-blue-400">plugins</span><span class="text-gray-300">: [</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">23</span>
                                    <span class="text-gray-300 ml-24"></span><span class="text-green-400">'advlist'</span><span class="text-gray-300">, </span><span class="text-green-400">'autolink'</span><span class="text-gray-300">, </span><span class="text-green-400">'lists'</span><span class="text-gray-300">, </span><span class="text-green-400">'link'</span><span class="text-gray-300">, </span><span class="text-green-400">'image'</span><span class="text-gray-300">, </span><span class="text-green-400">'charmap'</span><span class="text-gray-300">, </span><span class="text-green-400">'preview'</span><span class="text-gray-300">,</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">24</span>
                                    <span class="text-gray-300 ml-24"></span><span class="text-green-400">'anchor'</span><span class="text-gray-300">, </span><span class="text-green-400">'searchreplace'</span><span class="text-gray-300">, </span><span class="text-green-400">'visualblocks'</span><span class="text-gray-300">, </span><span class="text-green-400">'code'</span><span class="text-gray-300">, </span><span class="text-green-400">'fullscreen'</span><span class="text-gray-300">,</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">25</span>
                                    <span class="text-gray-300 ml-24"></span><span class="text-green-400">'insertdatetime'</span><span class="text-gray-300">, </span><span class="text-green-400">'media'</span><span class="text-gray-300">, </span><span class="text-green-400">'table'</span><span class="text-gray-300">, </span><span class="text-green-400">'code'</span><span class="text-gray-300">, </span><span class="text-green-400">'help'</span><span class="text-gray-300">, </span><span class="text-green-400">'wordcount'</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">26</span>
                                    <span class="text-gray-300 ml-20"></span><span class="text-gray-300">],</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">27</span>
                                    <span class="text-gray-300 ml-20"></span><span class="text-blue-400">toolbar</span><span class="text-gray-300">: </span><span class="text-green-400">'undo redo | blocks | '</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">28</span>
                                    <span class="text-gray-300 ml-24"></span><span class="text-green-400">'bold italic forecolor | alignleft aligncenter '</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">29</span>
                                    <span class="text-gray-300 ml-24"></span><span class="text-green-400">'alignright alignjustify | bullist numlist outdent indent | '</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">30</span>
                                    <span class="text-gray-300 ml-24"></span><span class="text-green-400">'removeformat | help'</span><span class="text-gray-300">,</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">31</span>
                                    <span class="text-gray-300 ml-20"></span><span class="text-blue-400">content_style</span><span class="text-gray-300">: </span><span class="text-green-400">'body { font-family:Helvetica,Arial,sans-serif; font-size:14px }'</span>
                                </div>
                                <div class="flex">
                                    <span class="text-gray-500 w-8 text-right pr-4">32</span>
                                    <span class="text-gray-300 ml-16"></span><span class="text-purple-400">}}</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">33</span>
                                <span class="text-gray-300 ml-12"></span><span class="text-gray-300">/&gt;</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">34</span>
                                <span class="text-gray-300 ml-12"></span><span class="text-gray-300">&lt;</span><span class="text-yellow-300">button</span> <span class="text-blue-400">onClick</span><span class="text-gray-300">=</span><span class="text-purple-400">{</span><span class="text-gray-300">log</span><span class="text-purple-400">}</span><span class="text-gray-300">&gt;Log editor content&lt;/</span><span class="text-yellow-300">button</span><span class="text-gray-300">&gt;</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">35</span>
                                <span class="text-gray-300 ml-8"></span><span class="text-gray-300">&lt;/&gt;</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">36</span>
                                <span class="text-gray-300 ml-4"></span><span class="text-gray-300">);</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">37</span>
