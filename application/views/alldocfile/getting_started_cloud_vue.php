                    ...
                    <div class="bg-gray-900 text-gray-100 p-6 rounded-lg font-mono text-sm overflow-x-auto">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-4"></span><span class="text-gray-300">&lt;</span><span class="text-yellow-300">div</span> <span class="text-blue-400">id</span><span class="text-gray-300">=</span><span class="text-green-400">"app"</span><span class="text-gray-300">&gt;</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">3</span>
                                <span class="text-gray-300 ml-8"></span><span class="text-gray-300">&lt;</span><span class="text-yellow-300">Editor</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">4</span>
                                <span class="text-gray-300 ml-12"></span><span class="text-blue-400">api-key</span><span class="text-gray-300">=</span><span class="text-green-400">"no-api-key"</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">5</span>
                                <span class="text-gray-300 ml-12"></span><span class="text-blue-400">:init</span><span class="text-gray-300">=</span><span class="text-green-400">"init"</span>
                            </div>
                            <div class="flex">
                                <span class="text-gray-500 w-8 text-right pr-4">6</span>
                                <span class="text-gray-300 ml-12"></span><span class="text-blue-400">initial-value</span><span class="text-gray-300">=</span><span class="text-green-400">"&lt;p&gt;This is the initial content of the editor.&lt;/p&gt;"</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-4"></span><span class="text-gray-300">&lt;/</span><span class="text-yellow-300">div</span><span class="text-gray-300">&gt;</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-4"></span><span class="text-purple-400">import</span> <span class="text-gray-300">{ Editor } </span><span class="text-purple-400">from</span> <span class="text-green-400">'@editflo/editflo-vue'</span><span class="text-gray-300">;</span>
                            </div>
                            <div class="flex">
                            ...
                            <div class="flex">
                                ...
                                <span class="text-gray-300 ml-4"></span><span class="text-purple-400">const</span> <span class="text-gray-300">init = {</span>
                            </div>
                            <div class="flex">
